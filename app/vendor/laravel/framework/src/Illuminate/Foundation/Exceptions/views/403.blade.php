...
<body class="nk-body body-wider bg-theme-grad-s2"><div class="nk-wrap ov-h"><div class="container"><main class="nk-pages nk-pages-centered tc-light px-0 text-center"><header class="pt-5"><a href="#" class="d-inline-block logo-lg"><img src="{{asset('assets/images/logo/logo.png')}}" srcset="{{asset('assets/images/logo/logo.png')}}" alt="logo"></a></header><div class="my-auto py-5"><div class="row justify-content-center"><div class="col-xl-6 col-md-7 col-sm-9"><div class="position-relative"><h2 class="title-xxl-grad">403</h2><h5 class="pb-2">Opps! Why you’re here?</h5><p class="">You are not authorised to view this page. Your IP address has been logged for monitoring purpose</p></div></div></div>  <a href="{{ url('/') }}" class="btn btn-grad btn-md btn-round">Back to home</a></div>
