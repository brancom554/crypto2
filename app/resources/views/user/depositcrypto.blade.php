                        ...
                        <div class="container-xl wide-lg">
                            <div class="nk-content-body">
                                <div class="buysell  ">
                                    ...
                                    <div class="buysell-title text-center"><h4 class="title">Deposit Cryptocurrency</h4></div>
                                                    ...
                                                    @foreach($gates as $data)
                                                        <li class="buysell-pm-item">
                                                            ...
                                                            <label class="buysell-pm-label" for="pm-{{$data->name}}">
                                                                <span class="pm-name">{{$data->name}}</span><span class="pm-icon"><em class="icon ni ni-coins"></em></span>
                                                            </label>
                                                        </li>
                                                    @endforeach
