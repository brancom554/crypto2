                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between g-3">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Withdrawal Log</h3>
                                                @php
                                                 $count = \App\WithdrawLog::whereUser_id(Auth::user()->id)->count();
                                                 @endphp
                                                <div class="nk-block-des text-soft"><p>You have a total of {{$count}} Withdrawal{s}</p></div>
                                            </div>
                                            <div class="nk-block-head-content">
                                            ...
                                            <div class="card-inner-group">
                                                <div class="card-inner">
                                                    <div class="card-title-group">
                                                        <div class="card-title"><h5 class="title">All Requests</h5></div>
                                                            ...
                                                            <div class="nk-tb-col">
                                                                <div class="nk-tnx-type">
                                                                   ...
                                                                   <div class="nk-tnx-type-icon bg-success-dim text-success">
                                                                    ...
                                                                    <div class="nk-tnx-type-text"><span class="tb-lead">{{App\WithdrawMethod::whereId($data->method_id)->first()->name}}</span><span class="tb-date">{!! date(' d/M/Y', strtotime($data->created_at)) !!}</span></div>
                                                                </div>
                                                            </div>
