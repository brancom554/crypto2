                                    ...
                                    <div class="nk-block-head nk-block-head-sm">
                                        <div class="nk-block-between g-3">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title page-title">Received {{$coin->name}}</h3>
                                                ...
                                                <div class="card-inner p-0">
                                                    <div class="nk-tb-list nk-tb-tnx">
                                                        <div class="nk-tb-item nk-tb-head">
                                                            ...
                                                            <div class="nk-tb-col text-right tb-col-sm"><span>Confirmations</span></div>
                                                        ...
                                                        <div class="nk-tb-item">
                                                            ...
                                                            <div class="nk-tb-col text-right">
                                                                <span class="tb-amount">{{$trx['amounts_received'][0]['amount']}} <span>{{$coin->currency}}</span></span><span class="tb-amount-sm">{{number_format($coin->price*$trx['amounts_received'][0]['amount'], 2)}} USD</span>
                                                            </div>
                                                            <div class="nk-tb-col text-right tb-col-sm">
                                                                <span class="tb-amount">{{$trx['confirmations']}} </span><span class="tb-amount-sm"> Confirmations</span>
                                                            </div>
                    ...
                    <div class="modal-body modal-body-md">
                        ...
                        <div class="nk-tnx-details">
                            <div class="nk-block-between flex-wrap g-3">
                                <div class="nk-tnx-type">
                                    ...
                                    <div class="nk-tnx-type-text">
                                        <h5 class="title">{{$trx['amounts_received'][0]['amount']}} {{$coin->name}}</h5>
                                        <span class="sub-text mt-n1">{{number_format($coin->price*$trx['amounts_received'][0]['amount'], 2)}} USD</span>
                                    </div>
                                </div>
                            ...
                            <div class="row gy-3">
                                ...
                                <div class="col-lg-6"><span class="sub-text">Sender</span><span class="caption-text text-break">{{$trx['amounts_received'][0]['recipient']}}</span></div>
                                <div class="col-lg-6"><span class="sub-text">Confirmation</span><span class="caption-text">{{$trx['confirmations']}}</span></div>
                                <div class="col-lg-6"><span class="sub-text">Amount Received</span><span class="caption-text">{{$trx['amounts_received'][0]['amount']}} {{$coin->currency}}</span></div>
                            </div>
                                                        ...
                                                        @endforeach
                                                        @else
                                                       <center>   No Received Transaction </center>
                                                        @endif
