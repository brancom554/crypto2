...
<div class="col-md-12"><div class="input-item input-with-label"><label class="input-item-label text-exlight">Contact Address</label><textarea value="{{$general->address}}"
                                           ...
                                           <div class="col-md-12"><div class="input-item input-with-label"><label class="input-item-label text-exlight">Escrow Percentage (%)</label><input value="{{$general->escrow}}"
                                           name="escrow" class="input-bordered" type="text"><span class="input-note">Admin Escrow Transaction Charge. </span></div></div>
                                           </div>
...
<option value="is-light">Default</option>
<option value="is-dark">Black</option>
<option value="bg-info">Blue</option>
<option value="bg-info-dim">Blue-light</option>
<option value="bg-danger-dim">Coral</option>
<option value="bg-success">Green</option>
<option value="bg-success-dim">Light Green</option>
<option value="bg-indigo">Navy Blue</option>
<option value="bg-purple-dim">Purple-light</option>
<option value="bg-purple">Purple</option>
<option value="bg-danger">Red</option>
<option value="bg-warning">Yellow</option>
<option value="bg-warning-dim">Yellow-Ligt</option>
</select>
