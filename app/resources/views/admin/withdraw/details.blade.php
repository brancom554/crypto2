...
@if($data->method_id == 1)
<li><div class="data-details-head">Payment Method</div><div class="data-details-des"><strong>{{$data->method->name}}</strong></div></li><!-- li -->
@elseif($data->method_id == 2)
<li><div class="data-details-head">Paypal Email</div><div class="data-details-des"><strong>{{$data->user->paypal}}</strong></div></li><!-- li -->
@elseif($data->method_id == 3)
<li><div class="data-details-head">Bank Name</div><div class="data-details-des"><strong>{{$data->user->bank}}</strong></div></li><!-- li -->
<li><div class="data-details-head">Account Name</div><div class="data-details-des"><strong>{{$data->user->accountname}}</strong></div></li><!-- li -->
<li><div class="data-details-head">Account Number</div><div class="data-details-des"><strong>{{$data->user->accountno}}</strong></div></li><!-- li -->
@endif
