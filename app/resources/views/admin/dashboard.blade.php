...
<div class="col-lg-6"><div class="token-statistics card card-token height-auto"><div class="card-innr"><div class="token-balance token-balance-with-icon"><div class="token-balance-icon"><em class="h2 color-white ti ti-wallet"></em></div><div class="token-balance-text"><h6 class="card-sub-title">Users' Wallet Balance</h6><span class="lead">{{number_format($bal, $basic->decimal)}} <span>{{$basic->currency}}</span></span></div></div><div class="token-balance token-balance-s2"><h6 class="card-sub-title">Summary</h6><ul class="token-balance-list"><li class="token-balance-sub"><span class="lead">{{number_format($pendingDeposit, $basic->decimal)}}{{$basic->currency_sym}} </span><span class="sub">Pending Deposits</span></li><li class="token-balance-sub"><span class="lead">{{number_format($declinedDeposit, $basic->decimal)}}{{$basic->currency_sym}}</span><span class="sub">Declined Deposits</span></li><li class="token-balance-sub"><span class="lead">{{number_format($totalTransfer, $basic->decimal)}}{{$basic->currency_sym}}</span><span class="sub">Total Transfer</span></li></ul></div></div></div></div>


<div class="col-lg-6"><div class="bg-theme token-statistics card card-token height-auto"><div class="card-innr"><div class="token-balance token-balance-with-icon"><div class="token-balance-icon"><em class="h2 color-white ti ti-shopping-cart"></em></div><div class="token-balance-text"><h6 class="card-sub-title">Total Withdrawal</h6><span class="lead">{{number_format($wpro, $basic->decimal)}} <span>{{$basic->currency}}</span></span></div></div><div class="token-balance token-balance-s2"><h6 class="card-sub-title">Summary</h6><ul class="token-balance-list"><li class="token-balance-sub"><span class="lead">{{number_format($wpro, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Processed</span></li><li class="token-balance-sub"><span class="lead">{{number_format($wpend, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Unprocessed</span></li><li class="token-balance-sub"><span class="lead">{{number_format($wdec, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Declined</span></li></ul></div></div></div></div>

<div class="col-lg-6"><div class="bg-secondary token-statistics card card-token height-auto"><div class="card-innr"><div class="token-balance token-balance-with-icon"><div class="token-balance-icon"><em class="h2 color-white ti ti-shopping-cart"></em></div><div class="token-balance-text"><h6 class="card-sub-title">Market Offer</h6><span class="lead">{{$offer}} <span>Active Offers</span></span></div></div><div class="token-balance token-balance-s2"><h6 class="card-sub-title">Summary</h6><ul class="token-balance-list"><li class="token-balance-sub"><span class="lead">{{number_format($oall*$basic->rate, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Total Offers</span></li><li class="token-balance-sub"><span class="lead">{{number_format($osold*$basic->rate, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Sold</span></li><li class="token-balance-sub"><span class="lead">{{number_format($oavail*$basic->rate, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Available Offers</span></li></ul></div></div></div></div>

<div class="col-lg-6"><div class="bg-secondary token-statistics card card-token height-auto"><div class="card-innr"><div class="token-balance token-balance-with-icon"><div class="token-balance-icon"><em class="h2 color-white ti ti-shopping-cart"></em></div><div class="token-balance-text"><h6 class="card-sub-title">Offer Sales</h6><span class="lead">{{$opay}} <span>Successful Trade</span></span></div></div><div class="token-balance token-balance-s2"><h6 class="card-sub-title">Summary</h6><ul class="token-balance-list"><li class="token-balance-sub"><span class="lead">{{number_format($opaid*$basic->rate, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Settled Trade</span></li><li class="token-balance-sub"><span class="lead">{{number_format($ounpaid*$basic->rate, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Unprocessed Trade</span></li><li class="token-balance-sub"><span class="lead">{{number_format($odispute*$basic->rate, $basic->decimal)}} {{$basic->currency_sym}}</span><span class="sub">Disputed Trade</span></li></ul></div></div></div></div>
